...
import Banner1 from "./components/common/Banner";
import CourseRequest from "./components/core/Dashboard/CourseRequest";
import InstructorCourseRequests from "./components/core/Dashboard/InstructorCourseRequests";
...
import AdminInstructors from "./components/core/Dashboard/AdminDashboard/AdminInstructors";
        ...
        >
          ...
          {user?.accountType === ACCOUNT_TYPE.STUDENT && (
            <>
              ...
              />
              <Route path="dashboard/course-request" element={<CourseRequest />} />
            </>
          )}
          ...
          {user?.accountType === ACCOUNT_TYPE.INSTRUCTOR && (
            <>
              ...
              <Route
                ...
                element={<EditCourse />}
              />
              <Route path="dashboard/instructor-course-requests" element={<InstructorCourseRequests />} />
            </>
          )}
